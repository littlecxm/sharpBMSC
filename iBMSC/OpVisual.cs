...
public partial class OpVisual : Form
{
    ...
    private void OpVisual_Load(object sender, EventArgs e)
    {
        ...
        Text = Strings1.fopVisual.Title;
        Label37.Text = Strings1.fopVisual.ColumnCaption;
        Label9.Text = Strings1.fopVisual.ColumnCaptionFont;
        Label30.Text = Strings1.fopVisual.Background;
        Label26.Text = Strings1.fopVisual.Grid;
        Label27.Text = Strings1.fopVisual.SubGrid;
        Label29.Text = Strings1.fopVisual.VerticalLine;
        Label40.Text = Strings1.fopVisual.MeasureBarLine;
        Label22.Text = Strings1.fopVisual.BGMWaveform;
        Label21.Text = Strings1.fopVisual.NoteHeight;
        Label24.Text = Strings1.fopVisual.NoteLabel;
        Label28.Text = Strings1.fopVisual.MeasureLabel;
        Label25.Text = Strings1.fopVisual.LabelVerticalShift;
        Label38.Text = Strings1.fopVisual.LabelHorizontalShift;
        Label39.Text = Strings1.fopVisual.LongNoteLabelHorizontalShift;
        Label33.Text = Strings1.fopVisual.HiddenNoteOpacity;
        Label34.Text = Strings1.fopVisual.NoteBorderOnMouseOver;
        Label35.Text = Strings1.fopVisual.NoteBorderOnSelection;
        Label23.Text = Strings1.fopVisual.NoteBorderOnAdjustingLength;
        Label31.Text = Strings1.fopVisual.SelectionBoxBorder;
        Label98.Text = Strings1.fopVisual.TSCursor;
        Label97.Text = Strings1.fopVisual.TSSplitter;
        Label96.Text = Strings1.fopVisual.TSCursorSensitivity;
        Label91.Text = Strings1.fopVisual.TSMouseOverBorder;
        Label86.Text = Strings1.fopVisual.TSFill;
        Label88.Text = Strings1.fopVisual.TSBPM;
        Label82.Text = Strings1.fopVisual.TSBPMFont;
        Label14.Text = Strings1.fopVisual.MiddleSensitivity;
        Label1.Text = Strings1.fopVisual.Width;
        Label2.Text = Strings1.fopVisual.Caption;
        Label4.Text = Strings1.fopVisual.Note;
        Label6.Text = Strings1.fopVisual.Label;
        Label5.Text = Strings1.fopVisual.LongNote;
        Label7.Text = Strings1.fopVisual.LongNoteLabel;
        Label8.Text = Strings1.fopVisual.Bg;
    }
