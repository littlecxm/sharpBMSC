...
namespace iBMSC
{
    public class Strings
    {
        ...
        public class FileType
        {
            ...
            public static string _movie = "Supported Movie Format (*.mpg, *.avi, *.mp4, *.wmv, *.webm)";
            public static string BMP = "Windows bitmap image (*.bmp)";
            public static string PNG = "Portable Network Graphic (*.png)";
            public static string JPG = "Joint Photographic Experts Group (*.jpg)";
            public static string GIF = "Graphics Interchange Format (*.gif)";
            public static string MPG = "Moving Picture Experts Group (*.mpg)";
            public static string AVI = "Audio Video Interleave (*.avi)";
            public static string MP4 = "MPEG phase 4 (*.mp4)";
            public static string WMV = "Windows Media Video (*.wmv)";
            public static string WEBM = "WebM (*.webm)";
